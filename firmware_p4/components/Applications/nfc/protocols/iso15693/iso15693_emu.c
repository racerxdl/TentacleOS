...
/* ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬
 * Constants
...
/* ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ State
 * machine
...
/* ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Module
 * state
...
void iso15693_emu_run_step(void) {
  ...
  if (s_state == ISO15693_STATE_SLEEP) {
     ...
     */
    bool wake = (timer_irq & TIMER_I_EON) || (tgt_irq & IRQ_TGT_WU_A) || (tgt_irq & IRQ_TGT_WU_F);
    if (wake) {
      s_sense_idle = 0;
      s_active_idle = 0;
