...
void ui_wifi_packets_menu_open(void) {
  if (screen_wifi_packets_menu) {
    lv_obj_del(screen_wifi_packets_menu);
    screen_wifi_packets_menu = NULL;
  }
  ...
  menu = menu_component_create(
      screen_wifi_packets_menu, "PACKETS", "/assets/icons/wifi_menu_icon.bin");
